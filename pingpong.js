...
Ball.prototype.update = function (player_paddle, computer_paddle) {
    ...
    if (this.y - this.radius < 0 || this.y + this.radius > HEIGHT) {
        if (this.y < 0) {
            ...
            alert('Wygrałeś z komputerem. Gratulacje');
        } else if (this.y + this.radius > HEIGHT) {
            console.log('Computer wins !');
            alert('Przegrałeś z komputerem. Spróbuj jeszcze raz');
        }
        resetGame();
    }
...
function resetGame() {
    ...
    player.paddle.y = HEIGHT - player.paddle.height;

    computer.paddle.x = WIDTH / 2 - computer.paddle.width / 2;
    computer.paddle.y = 0;
